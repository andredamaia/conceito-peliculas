...
$pageurl = "../conceito-peliculas"; // Development
...
switch($page){
	...
	case "home":
		$title = "Conceito Peliculas";
		$description = "Conceito Peliculas preparado para ser utilizado como base de desenvolvimento: <br /> SASS, Webpack, Three.js, ES6 modules, PHP";
		break;
